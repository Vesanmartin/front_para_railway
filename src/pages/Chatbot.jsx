...
function Chatbot() {
  ...
  const [mensajes, setMensajes] = useState([
    { rol: "sistema", texto: "Hola, soy CORDI, el analista de Grupo Cordillera. Pregúntame sobre ventas, KPIs o informes... si te atreves." }
  ]);
  const [pregunta, setPregunta]       = useState("");
  const [cargando, setCargando]       = useState(false);

  // Estado para los gráficos — guarda los datos del último mensaje
  ...
  // Estilos de los mensajes según el rol
      ...
      <div style={{
        ...
        {hayDatos && (
          <div style={{
            ...
            {/* Gráfico de ventas por mes — línea */}
